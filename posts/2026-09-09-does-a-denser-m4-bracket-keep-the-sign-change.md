...
**Figure 1.** Same-geometry SF-TDA gap versus constrained CNNC angle φ on the two geometry families. The [both_assigned_point_count]{.metric} both-assigned points come from the scored dump (ORCA 6.1.1 SF-TDA, LibXC BHANDHLYP, D3BJ/def2-QZVPP). S0-relaxed: φ = 90°, ΔE = [deltae_kjmol_s0_90]{.metric} kJ/mol; 95°, [deltae_kjmol_s0_95]{.metric}; 100°, [deltae_kjmol_s0_100]{.metric}; 105°, [deltae_kjmol_s0_105]{.metric}. T1-relaxed: 90°, [deltae_kjmol_t1_90]{.metric}; 95°, [deltae_kjmol_t1_95]{.metric}; 100°, [deltae_kjmol_t1_100]{.metric}; 105°, [deltae_kjmol_t1_105]{.metric}. Open markers are the reused 90° and 105° published two-root points; filled markers are the new 95° and 100° points. Adjacent both-assigned neighbors are joined by straight segments. The neighboring pair that changes sign is [flip_phi_lo_deg]{.metric}°–[flip_phi_hi_deg]{.metric}° on both families; [crossing_phi_deg_s0]{.metric}° and [crossing_phi_deg_t1]{.metric}° are those pairs’ linear interpolants at ΔE = 0, marked as plus marks labeled lin.
