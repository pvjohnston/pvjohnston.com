...
<figure>
  <img src="/images/hillel-m4-sft-dense-bracket-figure1.png" alt="Same-geometry SF-TDA gap ΔE versus constrained CNNC angle φ for S0-relaxed (solid blue circles) and T1-relaxed (dashed orange squares) M4 geometries at 90, 95, 100, and 105 degrees. Open markers are reused published two-root points at 90° and 105°; filled markers are new points at 95° and 100°. All eight points are labeled with ΔE. Plus marks on the zero line are the stored 100–105 linear interpolants, labeled lin.">
</figure>

**Figure 1.** A denser CNNC bracket still flips on 100–105° for both geometry families. Linear estimates from that pair are not MECPs. 90° and 105° are reused published two-root points (open markers); 95° and 100° are new (filled).
